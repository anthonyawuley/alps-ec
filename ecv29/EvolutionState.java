...
public class EvolutionState implements Singleton
    ...
    */
    ...
    public void run(int condition)
        ...
        /** ALPS Integration
         * 
         * This method is called in Awuley's ALPS integration but never defined.
         * This is an implementation of the undefined method
         * 
         */
        public void run(ALPSLayers alps, int condition)
        {
            if (alps.layers.get(alps.index).getIsBottomLayer() && alps.layers.get(alps.index).initializerFlag && condition == C_STARTED_FRESH)
                {
