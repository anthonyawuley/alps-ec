...
public class ALPSLayers {
	...
	public  void printAge()
	{
		...
		for(int i=0;i<this.layers.get(this.index).evolutionState.population.subpops.get(0).individuals.size();i++)
			System.out.print(this.layers.get(this.index).evolutionState.population.subpops.get(0).individuals.get(i).age +" ");
	...
	public  void printPopSize()
	{
		System.out.println("\nLayer :" + this.index + 
				" Generation :"+this.layers.get(this.index).evolutionState.generation);
		for(int i=0;i<this.layers.get(this.index).evolutionState.population.subpops.size();i++)
			System.out.print("subpop:"+i +" size:"+this.layers.get(this.index).evolutionState.population.subpops.get(0).individuals.size() +" ");
