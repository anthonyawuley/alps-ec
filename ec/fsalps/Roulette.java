 ...
 * <p>
 * Explanation of rolette operation is from http://stackoverflow.com/questions/298301/roulette-wheel-selection-algorithm
...
public abstract class Roulette {
    ...
    public void layerFrequencySelection(ALPSLayers alps, EvolutionState state) {
        ...
        try {   //Avoid Engine.alps.layers exception when alps.layers have not been set up
            if (Engine.fsalps_count_all_layers) {   /* Obtain initial node, value pairs from last layer */
        ...
        } catch (NullPointerException e) {   //this occurs during initialization, when ALPS is setting up
    ...
    /**
     * Convert frequency to probablity values
     *
     * @return arraylist of probability values
     */
     ...
     * @author anthony
     */
    public int spin(double prob) { //System.out.println("PRINTING PROBABILITY::::"+ prob);
