...
public class Pima extends GPProblem implements SimpleProblemForm
    ...
    public void evaluate(final EvolutionState state, 
    	...
    	if(!DataCruncher.IS_SHUFFLED)
            POPULATION_DATA = DataCruncher.shuffleData(state,Reader.readFile(trainFile,"\\s"),true);
    ...
    @Override
     public void describe(final EvolutionState state, 
    	...
    	if(!DataCruncher.IS_SHUFFLED)
            POPULATION_DATA = DataCruncher.shuffleData(state,Reader.readFile(testFile,"\\s"),true);
